  ...
  return (
    ...
    >
      <Container>
        ...
        >
          I&apos;m a Backend-Heavy Fullstack Developer with over 3 years of
          experience specializing in API development, cloud integration, and
          scalable server-side solutions. Experienced with all stages of the
          development cycle for dynamic web projects, with strong expertise in
          Node.js, TypeScript, Azure, and modern backend architectures.
        </Typography>
